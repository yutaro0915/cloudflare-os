...
const TOOL_DESCRIPTIONS: Record<(typeof CUSTOM_AGENT_TOOL_NAMES)[number], string> = {
  ...
  firecrawlSearch: 'Search the public web via the Firecrawl search API.',
...
const TOOL_CONTRACTS: Record<(typeof CUSTOM_AGENT_TOOL_NAMES)[number], ToolContract> = {
  ...
  firecrawlSearch: {fields: [field('query', 'string')], example: {query: 'cloudflare workers durable objects'}},
